...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HNewProduct_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 73, 12)
    ...
    "HNewProduct\0on_pushButton_2_clicked\0"
    "\0addNewProduct\0on_pushButton_clicked\0"
    "tipoSelected"
};
...
const QMetaObject HNewProduct::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HNewProduct.data,
      qt_meta_data_HNewProduct,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HNewProduct.stringdata))
