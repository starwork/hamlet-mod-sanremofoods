...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HWarehouse_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 36, 21),
QT_MOC_LITERAL(7, 58, 7),
QT_MOC_LITERAL(8, 66, 22),
...
const QMetaObject HWarehouse::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HWarehouse.data,
      qt_meta_data_HWarehouse,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HWarehouse.stringdata))
