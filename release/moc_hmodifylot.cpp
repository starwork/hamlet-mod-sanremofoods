...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HModifyLot_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 29, 23),
QT_MOC_LITERAL(5, 53, 17),
QT_MOC_LITERAL(6, 71, 7),
QT_MOC_LITERAL(7, 79, 21)
    },
    "HModifyLot\0update\0\0updateLot\0"
    "on_pushButton_2_clicked\0on_cbScad_toggled\0"
    "checked\0on_pushButton_clicked"
};
...
void HModifyLot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->updateLot();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 2: _t->on_pushButton_2_clicked(); break;
        case 3: _t->on_cbScad_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HModifyLot::update)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject HModifyLot::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HModifyLot.data,
      qt_meta_data_HModifyLot,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HModifyLot.stringdata))
